...
function DesbloquearConsultar()
	{
		if (CheckCamposConsulta()){document.getElementById("BotonConsultar").disabled=false;}
		else {document.getElementById("BotonConsultar").disabled="disabled";}
	}

function CheckCamposConsulta()
	{	
		if (
...
function DesbloquearBotonPresupuestar()
	{
 	 if (CheckCamposPresup()){document.getElementById("BotonPresupuestar").disabled=false;}
	 else {document.getElementById("BotonPresupuestar").disabled="disabled";}
	}
	
function CheckCamposPresup()
{
	if (
			document.getElementById("acc_cent").value!=0
			&& 
...
// SECCION jquery 
    $(document).ready(function()
		...
		$("#pespe_sub").click(function()
		{
					if ($("#acc_cent").val()!=0 && $("#acc_esp").val()!=0 && $("#un_eje").val()!=0 &&
										$("#pgen").val()!=0 && $("#psub").val()!=0 && $("#pespe").val()!=0 && $("#pespe_sub").val()!=0)
								{
									$.post("buscar_presupuesto.php", $("#forma").serialize(), function(data){
										$("#Mensaje").html(data);						
										});									
								}
								else
								{
									$("#Mensaje").html("Debe Seleccionar todas las Partidas");
								}
		})
		
		$("#un_eje").change(function()
		{
					if ($("#acc_cent").val()!=0 && $("#acc_esp").val()!=0 && $("#un_eje").val()!=0 &&
										$("#pgen").val()!=0 && $("#psub").val()!=0 && $("#pespe").val()!=0 && $("#pespe_sub").val()!=0)
								{
